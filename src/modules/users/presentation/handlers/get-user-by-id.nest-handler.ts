...
import { GetUserByIdQuery } from '../../../../core/application/users/queries/get-user-by-id.query';
import { GetUserByIdHandler as AppGetUserByIdHandler } from '../../../../core/application/users/queries/get-user-by-id.handler';
...
export class GetUserByIdNestHandler
  implements IQueryHandler<GetUserByIdQuery, UserOutput>
{
